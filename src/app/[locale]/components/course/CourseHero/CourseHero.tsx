...
const CourseHero: React.FC<CourseHeroProps> = ({ courseData }) => {
  ...
  return (
    <div className="container relative flex flex-col gap-4 md:flex-row md:gap-12 min-h-[300px]" style={{ backgroundImage: `url(/course-hero-bg.jpeg)` }}>
      <div className="container relative flex flex-col gap-4 md:flex-row md:gap-12 pb-6 md:py-10 min-h-[300px]">
        ...
        <div className="order-1 flex flex-col justify-center flex-1 md:order-1 md:max-w-[calc(100%_-_348px)] lg:max-w-[calc(100%_-_448px)]">
          ...
          <h1 className="text-white mb-2 text-[21px] font-semibold md:text-4xl">{courseData.title}</h1>
          ...
          <div>
            <div className="text-gray-400 overflow-hidden h-auto">
              <div>
                <p dir="ltr">
                  <span className="whitespace-pre-wrap" dangerouslySetInnerHTML={{ __html: courseData?.description }}></span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="md:sticky md:top-[112px]">
            <div className="md:border">
              ...
              <div className="hidden p-1 md:block">
                ...
                <div className="block md:hidden">
                  <h1 className="text-gray mb-3 mt-3 text-[21px] font-semibold md:text-4xl">{courseData.title}</h1>
                  <div className="mb-4 text-sm font-normal"></div>
                </div>
              </div>
              ...
              <div className="hidden md:block">
                <div className="grid py-2 md:p-4">
                  ...
                  <div>
                    {courseData.checklist.map((feature, index) => (
                      <div key={feature.id}>
                        <div className="flex items-center mb-3 leading-5">
                          <div className="inline-block h-[20px] w-[20px] transition-opacity duration-300 ease-in-out text-[0px]">
                            <img alt="icon" src={feature.icon} width="20" height="20" className="transparent" />
                          </div>
