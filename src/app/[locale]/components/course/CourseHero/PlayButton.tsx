const PlayButton = ({ handlePlayClick }: { handlePlayClick: () => void }) => (
  <span className="absolute left-1/2 top-1/2 z-[2] -translate-x-1/2 -translate-y-1/2 cursor-pointer" onClick={handlePlayClick}>
